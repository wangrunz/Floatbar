...
public class SettingFragment extends PreferenceFragmentCompat implements SharedPreferences.OnSharedPreferenceChangeListener {
                        ...
                        switch (which){
                            case DialogInterface.BUTTON_POSITIVE:
                                editor.putBoolean(getString(R.string.preference_fab_switch_key),false)
                                        ...
                                        .putString(getString(R.string.preference_rv_color_key),getString(R.string.preference_rv_color_default))
                                        .putString(getString(R.string.preference_rv_alpha_key),"50")
                                        .putString(getString(R.string.preference_side_key),getString(R.string.preference_side_default))
                                        .commit();
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String s) {
        ...
        else if (s.equals(getString(R.string.preference_rv_color_key))){
            String color = sharedPreferences.getString(s,"#000000");
            try{
                Color.parseColor(color);
            } catch (IllegalArgumentException e){
        ...
        else if (s.equals(getString(R.string.preference_rv_alpha_key))){
